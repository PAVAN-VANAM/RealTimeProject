    ...
    <div>
            ...
            <div class="container">
              <div class="hero-content">
                <h1 class="headline-lg" id="hero-label">
                  e-learning <span class="span">ACE engineering </span> collage
                </h1>
      ...
      <footer class="footer has-bg-image">
          ...
          <div class="container">
            <div class="footer-brand">
              ...
              <p class="title-sm footer-text">
                Hyderabad ,Ghatkesar ,501301 Telangana, India
              </p>
        ...
        <div class="footer-bottom">
          <div class="container">
            <p class="copyright">
              © Copyright 2024| All Rights Reserved by codewith chandra ajay
              praveen
            </p>
          </div>
        </div>
